...
Сообщение "Ошибка инициализации" может появиться если вы логинитесь к разным инстансам (например сначала на trolleway.nextgis.com, потом логинитесь на mostram.nextgis.com). При сообщении "Ошибка инициализации" пройтите в настройки Android --> Синхронизация --> настройки для NextGIS Простые учёты, и удалите старые аккаунты.
